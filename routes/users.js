...
//When the router gets a 'get' for request.
...
router.post('/register',(req,res)=>{
    ...
    //check if registration passwords match
        ...
        if(user) {
            ...
            bcrypt.hash(newUser.password,salt,
                (err,hash)=> {
                    ...
                    newUser.save()
                    .then((value)=>{
                        console.log('New Registration: Name:' + value.name + ' Email:' + value.email +' Date:' + value.date)
...
//If login is confirmed, send user to /dashboard
